...
/** TOURNOIS **/
/* 1*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
...
/* 2*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
...
/* 3*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
...
/* 4*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
...
/* 5*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
...
/* 6*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
...
/* 7*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
...
/* 8*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
	VALUES ('Japan Expo',
			'2022-04-01 10:00',
			'2022-04-01 17:30',
			'2022-04-08 00:00',
...
/* 9*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
...
/*10*/ INSERT INTO Tournoi (nom, dateHeureDebut, dateHeureFin, delaiAdmin, format, echellNbJoueur, idAdresse)
